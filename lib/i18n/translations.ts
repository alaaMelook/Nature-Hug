...
export const resources = {
  en: {
    translation: {
      ...
      faq4Content: "We offer a 30-day satisfaction guarantee. If you are not completely satisfied with your purchase, you can return it within 30 days for a full refund or exchange. Please refer to our 'Returns and Refunds' page for more instructions.",
  ...
  ar: {
    translation: {
      ...
      faq4Content: "نحن نقدم ضمان الرضا لمدة 30 يومًا. إذا لم تكن راضيًا تمامًا عن مشترياتك، يمكنك إرجاعها في غضون 30 يومًا لاسترداد أموالك بالكامل أو استبدالها. يرجى الرجوع إلى صفحة 'الإرجاع والاسترداد' لمزيد من التعليمات.",
