    ...
    <nav className="bg-white p-4 shadow-sm sticky top-0 z-10">
      <div className="w-full bg-white/80 ">
        <div className="mx-auto max-w-7xl px-4 py-1 flex items-center justify-between">
          ...
          {/* Links */}
          <div className="flex space-x-25 justify-between items-center ">
            <Link
              href="/"
              className="text-default hover:text-[#d1bba3] transition-colors duration-300 font-weight-400 text-xl"
            >
              {t("Home")}
            </Link>
            <Link
