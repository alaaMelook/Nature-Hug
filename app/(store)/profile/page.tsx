...
import { useProfileActions } from "@/ui/hooks/store/useProfileActions";
import { useProfileData } from "@/ui/(shop)/hooks/useProfileData";

export default function ProfilePage() {
  const { user } = useSupabaseAuth();
  const [newAddress, setNewAddress] = useState("");

  const { data: profile, isLoading, error } = useProfileData(user?.id);
